...
namespace Invector.vCharacterController
{
  public class vThirdPersonMotor : MonoBehaviour
  {
    ...
    public virtual void MoveCharacter(Vector3 _direction)
    {
      ...
      _rigidbody.linearVelocity = targetVelocity + platformVelocity;
    }
    ...
    public virtual void AirControl()
    {
      ...
      if (transform.position.y > heightReached) heightReached = _rigidbody.position.y;
    ...
    protected virtual void CheckGroundDistance()
    {
      if (_capsuleCollider != null)
      {
        ...
        var dist = 10f;
        // ray for RayCast
        Ray ray2 = new Ray(_rigidbody.position + new Vector3(0, colliderHeight / 2, 0), Vector3.down);
