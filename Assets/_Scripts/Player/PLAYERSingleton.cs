...
public class PLAYERSingleton : MonoBehaviour
{
  ...
  [HideInInspector] public vThirdPersonController vController;
  [HideInInspector] public vThirdPersonInput vInput;
  ...
  {
    if ((GMSingleton.i.inputManager.modeChange.WasReleasedThisFrame()
      && playerMode == PlayerMode.Normal)
      && !playerInteract.isTargettingInteractable)
    {
      playerFightMode.Activate();
    }
    else if ((GMSingleton.i.inputManager.modeChange.WasReleasedThisFrame()
